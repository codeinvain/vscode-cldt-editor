...
export class CldtCompletionProvider implements vscode.CompletionItemProvider {
    provideCompletionItems(
        ...
        const gravityOptions = [
            ...
            'auto', 'face', 'faces', 'body', 'auto:face', 'auto:faces',
            'auto:subject', 'auto:classic', 'ocr_text'
        ];
        ...
        // Effects
        const effects = [
            'blur', 'pixelate', 'sepia', 'grayscale', 'oil_paint', 'vignette',
            'cartoonify', 'brightness', 'contrast', 'saturation', 'hue', 'gamma',
            'sharpen', 'improve', 'auto_brightness', 'auto_contrast', 'auto_color',
            'red', 'green', 'blue', 'negate', 'screen', 'multiply',
            'trim', 'shadow', 'gradient_fade', 'vectorize', 'outline',
            'background_removal', 'generative_fill', 'generative_replace', 'generative_remove'
        ];
        effects.forEach(e => {
